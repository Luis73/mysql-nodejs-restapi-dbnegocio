const UserModel = require('../models/order_items2');

module.exports = app => {

  app.get('/api/orderitems2', (req, res) => { 
  ...
  app.get('/api/orderitems2/:id', (req, res) => {
    const userData = {
      id: req.params.id,
    };    
  ...
  app.post('/api/orderitems2', (req, res) => {
    var userData = {
        id: null , 
  ...
  app.put('/api/orderitems2/:id', (req, res) => {
    const userData = {
      id: req.params.id,
      order_id: req.body.order_id ,
      product_id: req.body.product_id ,
  ...
  app.delete('/api/orderitems2/:id', (req, res) => {
